...
# Seleccionar las características 'body-style' y 'aspiration'
x = df[['body-style', 'aspiration']]
y = df['price']

# Codificar las columnas 'body-style' y 'aspiration' como variables dummy (one-hot)
x = pd.get_dummies(x, columns=['body-style', 'aspiration'], drop_first=True)
