...
# Crear un gráfico de dispersión para visualizar las predicciones junto a los datos reales
plt.figure(figsize=(10, 6))
plt.scatter(x_test, y_test, c='blue', label='Datos Reales', marker='o')
plt.scatter(x_test, y_pred, c='red', label='Predicciones', marker='x')
